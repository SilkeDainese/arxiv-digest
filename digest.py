...
def _parse_arxiv_response(xml_data: str, category: str, config: dict[str, Any], compiled_colleagues: list[dict[str, Any]]) -> list[dict[str, Any]]:
...
def fetch_arxiv_papers(config: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    for i, category in enumerate(config["categories"]):
        ...
        category_papers = _parse_arxiv_response(xml_data, category, config, compiled_colleagues)
